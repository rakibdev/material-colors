...
export declare const createMaterialColors: <Colors extends Record<string, string>, Tones extends readonly number[] = readonly [80, 40, 20]>(userOptions?: DeepPartial<Options<Colors, Tones>>) => MaterialColors<{
    primary: string;
} & Colors, Tones>;
...
export declare const flattenMaterialColors: <Colors extends Record<string, string>, Tones extends readonly number[]>(colors: MaterialColors<Colors, Tones>) => FlatMaterialColors<Colors, Tones>;
export {};
